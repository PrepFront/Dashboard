...
const getTechResorces = () => {
  return getResources('tech')
}

function TechnicalResources() {

  const query = useQuery(['tech-resources'], getTechResorces, { staleTime: 1000 * 60 * 10 })
  return (
    <WaitForData dependencies={[query]}>
      <Box className={'flex m-10 flex-1 flex-col z-0 h-0 p-10'}>
        <Text.Heading>Technical Resources</Text.Heading>
